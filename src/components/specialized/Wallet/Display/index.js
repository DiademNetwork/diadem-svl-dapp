  ...
  <List>
    ...
    <ListItem divider={hasPendingTx}>
      ...
      <ListItemText
        primary={
          <Typography>
            {balance} SVL{unconfirmedBalance !== 0 ? ` (${unconfirmedBalance} SVL pending)` : ''}
            <Hidden xsDown>
              <HelpTooltip text={`This is your balance. Send SVL token(s) to your hot Diadem Network wallet address ${address} to use in Diadem Network`} />
              {balance > 0 && (
