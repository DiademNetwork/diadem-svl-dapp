  ...
  render () {
    ...
    return [
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Please provide a withdrawal address and an amount (max {balance} SVL minus fees of around 0.01 SVL) to withdraw tokens from your Diadem network hot wallet
          </DialogContentText>
          <TextField
            autoFocus={!fullScreen}
            data-qa-id="withdraw-form-amount-input"
            helperText='Fees are around 0.1 SVL'
