  ...
  render () {
    ...
    return (
      <Fragment>
        ...
        >
          <DialogTitle id="form-dialog-title">Invest</DialogTitle>
          <DialogContent>
            <DialogContentText paragraph>
              {confirmationsCount === 0 ? (
                `Are you sure of what you do ? It has not been confirmed yet`
              ) : (
            ...
            <TextField
              ...
              margin="normal"
              id='amount'
              label={`Amount in SVL - maximum ${walletBalance} SVL minus fees)`}
              value={amount}
